...
//npmrouter.get('/fisico',controladorEjercicio.getFisico);
...
router.post('/sustancia1',controladorEjercicio.postMuestra11);
router.post('/sustancia2',controladorEjercicio.postMuestra12);
router.post('/sustancia3',controladorEjercicio.postMuestra13);
router.post('/sustancia4',controladorEjercicio.postMuestra14)
router.post('/sustancia5',controladorEjercicio.postMuestra15);
router.post('/sustancia6',controladorEjercicio.postMuestra16);
router.post('/sustancia7',controladorEjercicio.postMuestra17);
router.post('/sustancia8',controladorEjercicio.postMuestra18);
