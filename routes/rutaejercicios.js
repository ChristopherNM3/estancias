...
router.post('/estimulacion4',controladorEjercicio.postRange4);
router.post('/estimulacion5',controladorEjercicio.postRange5);
router.post('/estimulacion6',controladorEjercicio.postRange6);
