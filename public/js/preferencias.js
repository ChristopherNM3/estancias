...
function cambiarImagenes(){
    ...
    div1.innerHTML = `<img id="img1" src="./imagenes/comida/${valores[0]}.jpg" onclick="escogerImagen('img1', 'img2', ${cont})" style="">`;
    div2.innerHTML = `<img id="img2" src="./imagenes/comida/${valores[1]}.jpg" onclick="escogerImagen('img2', 'img1', ${cont})" style="">`;
}
